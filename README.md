...
The **Museum With No Frontiers — Funerary Objects** gallery, built from the published
dataset `@museumwnf/funerary-objects-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/funerary-objects-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/funerary-objects/> through the reusable workflows in
