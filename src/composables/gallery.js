...
// `useGalleryData.js` used to be byte-identical local copies of what funerary-objects
...
// legacy project key, no UUID — funerary-objects shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (funerary-objects-data 1.0.11+), an outside
