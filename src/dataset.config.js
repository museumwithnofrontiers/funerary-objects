...
const about = {
  body: 'funeraryObjects.about.body',
...
export default {
  ...
  home: {
    title: 'funeraryObjects.identity.title',
    intro: 'funeraryObjects.home.intro',
    cards: [
      {
        title: 'funeraryObjects.nav.catalogue',
        description: 'funeraryObjects.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'funeraryObjects.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'funeraryObjects.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'funeraryObjects.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'funeraryObjects.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'funeraryObjects.partnerObjects.emptyPartner',
  //         emptyInstitution: 'funeraryObjects.partnerObjects.emptyInstitution',
  //         institutionSummary: 'funeraryObjects.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'funeraryObjects.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'funeraryObjects.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
